...
const SingleMentorProfile = () => {
  ...
  const ContentShowHandler = (option) => {
    console.log(option);
    if (option === "overview") {
                  ...
                  <div className="fkjhgdfbghh my-5">
                    <ul className="tabs">
                      <li
                        ...
                        data-tab="tab-9"
                        onClick={() => ContentShowHandler("overview")}
                      >
                        Overview
                      </li>
                      <li
                        className="tab-link"
                        data-tab="tab-10"
                        onClick={() => ContentShowHandler("rating")}
                      >
                        Rating & Reviews
                      </li>
                    </ul>
                          ...
                          <div className="jhdfgfjgg">
                            <div className="hghgg">
                              ...
                              <div className="dfkjbghdfffg">
                                <p>
                                  As a business analyst professional, I feel
                                  very lucky to have Tarun Sir as my mentor. I
                                  got in-depth knowledge about the subject. It
                                  helps me to cope with the dynamicity of it
                                  quite beautifully. His dedication to mentoring
                                  the students is excellent. If somebody asks to
                                  me for a business analyst mentor I will surely
