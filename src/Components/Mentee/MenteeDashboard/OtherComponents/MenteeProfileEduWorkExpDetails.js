...
const MenteeProfileEduWorkexpDetails = ({ singleMentee, user, token }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    mentee_instituteName: singleMentee[0]?.mentee_institute,
    mentee_courseName: singleMentee[0]?.mentee_courseName,
    mentee_institute_location: singleMentee[0]?.mentee_institute_location,
    mentee_institute_Start_Year: singleMentee[0]?.mentee_institute_Start_Year,
    mentee_institute_End_Year: singleMentee[0]?.mentee_institute_End_Year,
    ...
    mentee_workexp_CompanyName: singleMentee[0]?.mentee_workexp_CompanyName,
    mentee_workexp_Role: singleMentee[0]?.mentee_workexp_Role,
    mentee_workexp_Desc: singleMentee[0]?.mentee_workexp_Desc,
    mentee_workexp_Location: singleMentee[0]?.mentee_workexp_Location,
    mentee_workexp_Start_Year: singleMentee[0]?.mentee_workexp_Start_Year,
    mentee_workexp_End_Year: singleMentee[0]?.mentee_workexp_End_Year,
  });
