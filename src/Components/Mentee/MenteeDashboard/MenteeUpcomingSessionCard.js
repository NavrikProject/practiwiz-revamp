...
const MenteeUpcomingSessionCard = () => {
  return (
                ...
                <div className="dfhjbghfjgfgh22">
                  ...
                  <div className="row mt-3 justify-content-center">
                    ...
                    <div className="col-lg-6 mb-2">
                      <div className="ierjuhrt_left">
                        <h5 className="mb-0">
                          <i className="fa-solid me-1 fa-calendar-days"></i> Date :
                        </h5>
                    ...
                    <div className="col-lg-6 mb-2">
                      <div className="ierjuhrt_left">
                        <h5 className="mb-0">
                          <i className="fa-regular me-1 fa-face-smile"></i> Rating :
                        </h5>
                  ...
                  <div className="kbfhgfgfg d-flex justify-content-center mt-3">
                    <button className="btn-main me-1">Join Now</button>

                    <button className="btn-main">Cancel</button>

                    <button className="btn-main mt-2">Request Reschedule</button>
                  </div>
                </div>
              </div>
            </div>
